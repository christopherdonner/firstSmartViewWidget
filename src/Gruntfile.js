...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    requirejsBundleIndex: {
      all: {
        src: [
          'bundles/donner-all.js'
        ],
        dest: 'bundles/donner-index',
        options: {
          prefix: 'donner'
        }
      }
    ...
    replace: {
      ...
      debug: {
        files: [
          {
            src: ['donner-extensions.json'],
            dest: '../out-debug/donner-extensions.json'
          }
        ]
      },
      release: {
        files: [
          {
            src: ['donner-extensions.json'],
            dest: '../out-release/donner-extensions.json'
          }
        ]
      }
    },
    ...
    copy: {
      module: {
        files: [
          {
            cwd: "../srcmodules/donnertestwidget",
            src: "**",
            dest: "../out-module/donnertestwidget",
            expand: true
          },
          {
            cwd: "../out-release",
            src: "**",
            dest: "../out-module/donnertestwidget/support",
            expand: true
          }
        ]
      }
    ...
    languagepack: {
      all: {
        options: {
          ...
          bundleIndexes: {
            'bundles/donner-index': ['bundles/donner-all']
          },
